...
class MapVaxDashboardView extends DashboardView
{
    ...
    <div class="row">
        ...
        <div class="cell box">
            <a class="action-button" href="DIR_ROOT/admin/vaccination-sites/edit?id=$cd_ref">
                <div>
                    <span class="iconify" data-icon="mdi-pencil"></span>
                    Edit
                </div>
            </a>
            <a class="action-button" href="DIR_ROOT/admin/vaccination-sites/delete?id=$cd_ref">
                <div>
